...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _243: x0 => x0.remove(),
      _244: (x0,x1) => ({format: x0,totalMemory: x1}),
      _245: (x0,x1) => globalThis.Viz(x0,x1),
      _246: (x0,x1) => x0.append(x1),
      _247: (x0,x1,x2) => x0.insertAdjacentHTML(x1,x2),
      _248: (x0,x1) => x0.querySelectorAll(x1),
      _249: (x0,x1) => x0.querySelector(x1),
      _250: (x0,x1) => x0.getAttribute(x1),
      _251: (x0,x1) => x0.add(x1),
      _252: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _253: (x0,x1) => x0.contains(x1),
      _254: (x0,x1) => x0.remove(x1),
      _259: (x0,x1) => x0.item(x1),
      _260: (x0,x1) => x0.getNamedItem(x1),
