...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BB: (a, i) => a[i],
      BC: x0 => x0.stopPropagation(),
      C: Function.prototype.call.bind(Number.prototype.toString),
      CB: x0 => x0.textContent,
      CC: (x0,x1) => { x0.title = x1 },
      ...
      KB: (x0,x1) => { x0.id = x1 },
      KC: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.F(f,arguments.length,x0) }),
      L: o => o === undefined,
      LB: x0 => new Worker(x0),
      LC: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports.G(f,arguments.length,x0,x1) }),
      M: o => String(o),
      ...
      PC: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      Q: (x0,x1) => x0.remove(x1),
      QB: (x0,x1) => x0.postMessage(x1),
      QC: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      R: (x0,x1) => x0.error(x1),
      RB: (x0,x1) => { x0.onerror = x1 },
      RC: Function.prototype.call.bind(DataView.prototype.getFloat64),
      S: (x0,x1) => x0.add(x1),
      SB: (x0,x1) => { x0.onmessage = x1 },
      SC: Function.prototype.call.bind(DataView.prototype.getFloat32),
      T: (x0,x1) => x0.info(x1),
      TB: x0 => x0.terminate(),
      TC: Function.prototype.call.bind(DataView.prototype.getUint32),
      U: (string, times) => string.repeat(times),
      UB: x0 => x0.stack,
      UC: Function.prototype.call.bind(DataView.prototype.getInt32),
      ...
      XB: x0 => x0.success,
      XC: Function.prototype.call.bind(DataView.prototype.getUint8),
      Y: () => globalThis.console,
      YB: x0 => x0.generation,
      YC: Function.prototype.call.bind(DataView.prototype.getInt8),
