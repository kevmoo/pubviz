...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _253: (x0,x1,x2) => x0.insertAdjacentHTML(x1,x2),
      _254: (x0,x1) => x0.add(x1),
      _255: (x0,x1) => x0.querySelectorAll(x1),
      _256: (x0,x1) => x0.querySelector(x1),
      _257: (x0,x1) => x0.getAttribute(x1),
      _258: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _259: (x0,x1) => x0.hasAttribute(x1),
      _260: (x0,x1) => x0.contains(x1),
      _261: (x0,x1) => x0.remove(x1),
