...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      GC: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.F(f,arguments.length,x0) }),
      H: Function.prototype.call.bind(Number.prototype.toString),
      HB: (handle) => clearTimeout(handle),
      HC: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports.G(f,arguments.length,x0,x1) }),
      I: Function.prototype.call.bind(String.prototype.indexOf),
      IB: x0 => x0.offsetHeight,
      IC: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      J: (s, p, i) => s.lastIndexOf(p, i),
      JB: x0 => x0.relatedTarget,
      JC: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      K: (exn) => {
      ...
      L: o => o === undefined,
      LB: x0 => new Worker(x0),
      LC: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      M: o => String(o),
      MB: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.D(f,arguments.length,x0) }),
      MC: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      N: (x0,x1) => new URL(x0,x1),
      NB: (module,f) => finalizeWrapper(f, function(x0) { return module.exports.E(f,arguments.length,x0) }),
      NC: Function.prototype.call.bind(DataView.prototype.getFloat64),
      O: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      OB: x0 => ({format: x0}),
      OC: Function.prototype.call.bind(DataView.prototype.getFloat32),
      ...
      RC: Function.prototype.call.bind(DataView.prototype.getUint16),
      S: (x0,x1) => x0.add(x1),
      SB: (x0,x1) => { x0.onmessage = x1 },
      SC: Function.prototype.call.bind(DataView.prototype.getInt16),
      T: (x0,x1) => x0.info(x1),
      TB: x0 => x0.terminate(),
      TC: Function.prototype.call.bind(DataView.prototype.getUint8),
      ...
      jB: (x0,x1) => { x0.checked = x1 },
      k: () => globalThis.Math,
      kB: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      l: (x0,x1) => x0.item(x1),
      lB: x0 => x0.pathname,
      m: o => o,
      mB: x0 => x0.history,
      ...
      vB: (x0,x1) => { x0.title = x1 },
      w: x0 => x0.style,
      wB: (x0,x1) => { x0.disabled = x1 },
      x: x0 => x0.id,
      xB: x0 => x0.stopPropagation(),
      y: (string, token) => string.split(token),
      yB: (x0,x1) => { x0.title = x1 },
