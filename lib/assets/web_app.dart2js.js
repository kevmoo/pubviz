...
o=p.d
if(o!=null&&!o){n.Y5(0,"fontcolor","red")
if(n.W(0,k)==="gray")n.Y5(0,k,"pink")
else n.Y5(0,k,"red")}p=p.a
if(p===c)n.Y5(0,"constraint","false")
h.push(new A.DC(j,p,n))}}},
MG:function MG(a){this.a=a},
T4:function T4(a){this.a=a},
oe(a){var s,r,q,p,o="isPrimary",n=A.Bt(a.W(0,"name")),m=A.r(a.W(0,"version"))
m=m==null?null:A.pT(m)
s=J.M1(t.j.a(a.W(0,"dependencies")),new A.TK(),t.c).zH(0)
r=A.r(a.W(0,"latestVersion"))
r=r==null?null:A.pT(r)
if(a.W(0,o)==null)q=!1
else{q=A.M4(a.W(0,o))
q=q===!0}if(a.W(0,"onlyDev")==null)p=!0
else{p=A.M4(a.W(0,"onlyDev"))
p=p!==!1}return new A.px(n,m,new A.GQ(s,t._),q,p,r)},
...
t.a.a(a)
s=A.Bt(a.W(0,"name"))
r=B.NS.Zw(A.Bt(a.W(0,"versionConstraint")))
q=A.M4(a.W(0,"isDevDependency"))
return new A.Zz(s,r,q===!0,A.M4(a.W(0,"includesLatest")))},
$S:40}
A.is.prototype={
...
if(!a&&!b)return q
s=b?q.QW(a):q.zr(a)
r=new A.is(q.a,new A.Gj(s,t.J))
r.q(!1)
return r},
QW(a1){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e=t.N,d=A.Fl(e,t.b),c=this.b.a,b=A.L(c).C("G<2>"),a=b.C("i1<cX.E,qU>"),a0=A.ev(new A.i1(new A.oi(new A.G(c,b),new A.uB(),b.C("oi<cX.E>")),new A.kW(),a),a.C("cX.E"))
b=A.Qv(a0,e)
a=this.a
b.AN(0,a)
s=A.ev(b,e)
while(s.length!==0){r=c.W(0,s.pop())
if(r!=null)for(q=r.c.a,p=A.L(q),o=new A.lm(q,q.r,p.C("lm<1>")),o.c=q.e,p=p.c;o.G();){q=o.d
if(q==null)q=p.a(q)
if(a1&&q.c)continue
q=q.a
if(b.AN(0,q))s.push(q)}}n=A.Fl(e,t.U)
for(s=A.L(b),q=A.rj(b,b.r,s.c),p=q.$ti.c;q.G();){o=q.d
m=c.W(0,o==null?p.a(o):o)
if(m!=null)for(o=m.c.a,l=A.L(o),k=new A.lm(o,o.r,l.C("lm<1>")),k.c=o.e,o=m.a,l=l.c;k.G();){j=k.d
if(j==null)j=l.a(j)
if(a1&&j.c)continue
...
h=A.ev(i,A.L(i).c)
g=A.tM(i,e)
while(h.length!==0){b=n.W(0,h.pop())
if(b==null)b=A.r2(e)
b=b.gA(b)
while(b.G()){s=b.gl()
if(g.AN(0,s))h.push(s)}}g.AN(0,a)
for(e=A.rj(g,g.r,A.L(g).c),b=e.$ti.c,a=t._;e.G();){s=e.d
if(s==null)s=b.a(s)
r=c.W(0,s)
if(r!=null){q=r.c.a
p=A.L(q).C("oi<1>")
...
q=r.b
o=r.f
d.Y5(0,s,new A.px(p,q,new A.GQ(f,a),r.d,!0,o))}}return d},
zr(a){var s,r,q,p,o,n,m=t.N,l=A.Fl(m,t.b),k=this.b.a,j=A.L(k).C("G<2>"),i=j.C("i1<cX.E,qU>"),h=A.ev(new A.i1(new A.oi(new A.G(k,j),new A.PH(),j.C("oi<cX.E>")),new A.Cw(),i),i.C("cX.E"))
j=A.Qv(h,m)
j.AN(0,this.a)
m=A.ev(j,m)
while(m.length!==0){s=k.W(0,m.pop())
if(s==null)continue
for(i=s.c.a,r=A.L(i),q=new A.lm(i,i.r,r.C("lm<1>")),q.c=i.e,r=r.c;q.G();){i=q.d
if(i==null)i=r.a(i)
if(a&&i.c)continue
i=i.a
if(j.AN(0,i))m.push(i)}}for(m=A.rj(j,j.r,A.L(j).c),j=t._,i=m.$ti.c;m.G();){r=m.d
if(r==null)r=i.a(r)
q=k.W(0,r)
q.toString
p=q.c.a
...
l.Y5(0,r,new A.px(q.a,q.b,new A.GQ(n,j),q.d,!0,q.f))}return l}}
A.AH.prototype={
$1(a){return!a.d},
$S:2}
A.Aw.prototype={
...
$S:38};(function aliases(){var s=J.zh.prototype
...
r(A.Pl,A.B7)
q(A.mP,[A.C4,A.vG])
q(A.Tp,[A.eR,A.Ay,A.lc,A.dC,A.VX,A.th,A.ha,A.WM,A.jZ,A.OR,A.vK,A.pU,A.F0,A.wZ,A.BW,A.HJ,A.kk,A.pH,A.Ap,A.MG,A.T4,A.TK,A.AH,A.Aw,A.ax,A.uB,A.kW,A.pI,A.c6,A.PH,A.Cw,A.PD,A.vN,A.e,A.C,A.w,A.em,A.Lb,A.QA,A.Cv,A.ed,A.AR,A.lg,A.qK,A.w0,A.FL,A.yx,A.jf,A.tD,A.R9,A.PJ])
q(A.eR,[A.hN,A.wN,A.SX,A.Gs,A.FZ,A.mN,A.VC,A.GR,A.RJ,A.tb,A.GJ])
r(A.LP,A.WU)
q(A.Vj,[A.hh,A.Xv])
r(A.XX,A.hh)
q(A.Ay,[A.aH,A.Vs,A.Ft,A.yH,A.da,A.oQ,A.fG,A.rt,A.xR,A.RT,A.rq,A.RW,A.Vp,A.Ev,A.Vb,A.Hd,A.TZ,A.lN,A.Ug,A.p,A.D])
r(A.W0,A.Ez)
q(A.lc,[A.zx,A.rT])
q(A.il,[A.N5,A.uw])
q(A.eH,[A.T1,A.b0])
...
s(A.RU,A.KP)
s(A.zw,A.Mg)})()
var v={G:typeof self!="undefined"?self:globalThis,typeUniverse:{eC:new Map(),tR:{},eT:{},tPV:{},sEA:[]},mangledGlobalNames:{KN:"int",CP:"double",lf:"num",qU:"String",a2:"bool",c8:"Null",zM:"List",Mh:"Object",Z0:"Map",vm:"JSObject"},mangledNames:{},types:["~()","~(vm)","a2(px)","a2(Zz)","~(@)","~(~())","KN(+constraint,isDev,isEdgeOutdated,isNodeOutdated,name(qU,a2,a2,a2,qU),+constraint,isDev,isEdgeOutdated,isNodeOutdated,name(qU,a2,a2,a2,qU))","c8(@)","c8()","KN()","qU(qU)","qU(px)","a2(qU)","a2(uu)","c8(~())","@(@,qU)","~(Z0<qU,qU>)","~(qU,Z0<qU,qU>)","~(uu)","~(DC)","Mh(qU)","M3?()","VV?()","XL?()","@(qU)","@(@)","c8(@,Gz)","~(Zz)","~(KN,@)","Ol<qU>()","c8(Mh,Gz)","N3<qU,px>(qU,@)","~(Mh?,Mh?)","+element,id(vm,qU)(vm)","+constraint,element,from,isDev,to(qU,vm,qU,a2,qU)(vm)","0&(qU,KN?)","qU(cX<+constraint,isDev,isEdgeOutdated,isNodeOutdated,name(qU,a2,a2,a2,qU)>)","qU(+constraint,isDev,isEdgeOutdated,isNodeOutdated,name(qU,a2,a2,a2,qU))","~(vm,qU,zM<+constraint,isDev,isEdgeOutdated,isNodeOutdated,name(qU,a2,a2,a2,qU)>)","KN(@,@)","Zz(@)"],interceptorsByTag:null,leafTags:null,arrayRti:Symbol("$ti"),rttc:{"2;element,id":(a,b)=>c=>c instanceof A.Pl&&a.b(c.a)&&b.b(c.b),"5;constraint,element,from,isDev,to":a=>b=>b instanceof A.C4&&A.Gc(a,b.a),"5;constraint,isDev,isEdgeOutdated,isNodeOutdated,name":a=>b=>b instanceof A.vG&&A.Gc(a,b.a)}}
