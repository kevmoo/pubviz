...
W(){var s=0,r=A.F(t.n),q=1,p=[],o=[],n=this,m,l,k,j,i,h,g,f,e,d,c,b,a
var $async$W=A.l(function(a0,a1){if(a0===1){p.push(a1)
s=q}for(;;)switch(s){case 0:b=n.c
if(b!=null){b.remove()
...
b=b.a
b===$&&A.Q4()
l=f.wH(!b.d.checked,b.f.checked)
k=A.iQ(l)
b=n.b
b.toString
j=b.renderString(k,{format:"svg"})
n.eY(j)
o.push(5)
s=4
break
...
d=v.G
c=d.document
c=c.querySelector("#crash-trace")
if(c==null)c=A.AN(c)
c.textContent=b+"\n"+f
f=d.document.querySelector("#crash-report")
b=f==null?A.AN(f):f
b.classList.remove("hidden")
d=d.document.querySelector("#graph-container")
b=d==null?A.AN(d):d
