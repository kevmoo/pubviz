...
r.y=s
p=s}return p},
PJ(a){var s,r,q,p,o,n,m,l,k,j,i,h,g=this,f="click",e=v.G,d=e.document.querySelector("#controls-content")
if(d==null)d=A.AN(d)
d.innerHTML=""
for(s=g.gD5(),r=0;r<5;++r){q=s[r]
p=e.document.createElement("label")
o=e.document.createElement("input")
o.type="checkbox"
n=q.a
o.id=n[4]
p.appendChild(o)
p.appendChild(e.document.createTextNode(" "+n[7]))
d.appendChild(p)
g.gxR().Y5(0,n[4],o)
if(!n[5].$0()){o.disabled=!0
if(J.Hm(n[10].$0())!==0)p.title=n[10].$0()}else if(J.Hm(n[0].$0())!==0)p.title=n[0].$0()}s=e.document.createElement("button")
s.id="resetButton"
...
j.className="export-row"
p=e.document.createElement("span")
p.className="export-label"
p.textContent=k
i=e.document.createElement("button")
i.className="export-btn copy"
i.title="Copy "+k+" to clipboard"
i.innerHTML="\ud83d\udccb <span>Copy</span>"
h=e.document.createElement("button")
h.className="export-btn save"
h.title="Download "+k+" file"
h.innerHTML="\u2b07\ufe0f <span>Save</span>"
j.appendChild(p)
j.appendChild(i)
j.appendChild(h)
d.appendChild(j)
A.JE(i,f,new A.AK(g,k),!1)
A.JE(h,f,new A.AX(g,k),!1)}g.Lq()
g.yu()
g.tJ()
s=e.document.body
s.toString
...
s=e.document.body
s.toString
A.JE(s,"change",new A.ab(g),!1)
s=e.document.body
s.toString
A.JE(s,f,new A.aj(g),!1)
A.JE(e.window,"keydown",g.gMh(),!1)
e=e.document.querySelector("#version")
if(e==null)e=A.AN(e)
e.textContent="v6.1.0"},
...
r(A.Mh,null)
q(A.Mh,[A.FK,J.vB,A.rY,J.a,A.Ge,A.zl,A.cX,A.a7,A.MH,A.SO,A.JB,A.SU,A.z,A.WU,A.n,A.vI,A.Vj,A.Zr,A.te,A.bq,A.XO,A.il,A.db,A.N6,A.Gf,A.HQ,A.VR,A.EK,A.Jc,A.ET,A.lY,A.W3,A.ih,A.GV,A.OH,A.Pf,A.Fe,A.vs,A.OM,A.xI,A.m0,A.bn,A.lm,A.ar,A.KP,A.Pn,A.a1,A.vX,A.YI,A.Uk,A.zF,A.fU,A.ZF,A.a6,A.k5,A.VS,A.CD,A.aE,A.N3,A.c8,A.Zd,A.P1,A.v,A.aA,A.wL,A.W9,A.ms,A.Mg,A.Lm,A.uu,A.DC,A.qq,A.M3,A.bM,A.VV,A.hT,A.Zz,A.px,A.u3,A.FM,A.CC,A.J,A.e,A.XG,A.Fk,A.xC])
