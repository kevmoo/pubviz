...
Yr(a6,a7){var s=0,r=A.F(t.H),q,p=2,o=[],n=this,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5
var $async$dV=A.l(function(a8,a9){if(a8===1){o.push(a9)
s=p}for(;;)switch(s){case 0:a3=v.G
a4="clipboard" in a3.window.navigator
if(a7&&!a4){n.jz("\u26a0\ufe0f Clipboard API not available in this context")
s=1
break}p=4
case 7:switch(a6.a){case 0:s=9
break
case 1:s=10
break
case 2:s=11
...
d===$&&A.Q4()
c=n.gxR()
b=c.WH(0,"devDependenciesCheckbox").checked
a=c.WH(0,"outdatedOnlyCheckbox").checked
a0=c.WH(0,"workspaceOnlyCheckbox").checked
m=A.iQ(d.c6(b,c.WH(0,"hideIsolatedCheckbox").checked,a,a0))
s=a7?12:14
break
case 12:s=15
return A.j(A.f(a3.window.navigator.clipboard.writeText(m),t.X),$async$dV)
...
case 13:s=8
break
case 10:l=a3.document.querySelector("#graph-container svg")
...
break
case 16:s=19
return A.j(A.f(a3.window.navigator.clipboard.writeText(k),t.X),$async$dV)
...
case 17:s=8
break
case 11:j=a3.document.querySelector("#graph-container svg")
if(j==null){n.jz("\u26a0\ufe0f No graph found to export")
s=1
break}n.jz("Processing PNG...")
i=A.Bt(j.outerHTML)
h=new a3.Blob(A.QI([i],t.s),{type:"image/svg+xml"})
g=a3.URL.createObjectURL(h)
a1=a3.document.createElement("img")
a1.src=g
f=a1
f.onload=A.k6(new A.OS(n,j,f,g,a7))
f.onerror=A.k6(new A.np(n,g))
s=8
break
case 8:p=2
s=6
...
F4(a,b){var s=v.G.document.createElement("a")
s.href=a
s.download=b
s.click()},
...
$S:39}
A.OS.prototype={
$1(a){var s=this,r=v.G,q=r.document.createElement("canvas"),p=s.b.getBoundingClientRect(),o=J.cf(p.width,0)?1000:J.oW(p.width),n=J.cf(p.height,0)?1000:J.oW(p.height),m=q
m.width=o*2
m.height=n*2
m=q.getContext("2d")
if(m==null)m=A.AN(m)
...
m.fillStyle="white"
m.fillRect(0,0,o,n)
m.drawImage.apply(m,[s.c,0,0,o,n])
r.URL.revokeObjectURL(s.d)
r=s.a
if(s.e)q.toBlob(A.k6(new A.RC(r)),"image/png")
else q.toBlob(A.k6(new A.vW(r)),"image/png")},
$S:8}
A.RC.prototype={
$1(a){if(a!=null)new A.kj(this.a,a).$0()},
$S:11}
A.kj.prototype={
...
$1(a){var s,r,q
if(a!=null){r=v.G
s=r.URL.createObjectURL(a)
q=this.a
q.F4(s,"dependencies.png")
r.URL.revokeObjectURL(s)
q.jz("PNG Saved")}},
$S:11}
A.np.prototype={
$1(a){v.G.URL.revokeObjectURL(this.b)
...
s(A,"q6","mA",16)
s(A,"xh","Wc",31)
p(A.XG.prototype,"gMh","e9",0)})();(function inheritance(){var s=hunkHelpers.mixin,r=hunkHelpers.inherit,q=hunkHelpers.inheritMany
r(A.Mh,null)
q(A.Mh,[A.FK,J.vB,A.rY,J.a,A.Ge,A.zl,A.cX,A.a7,A.MH,A.SO,A.JB,A.SU,A.z,A.WU,A.n,A.vI,A.Vj,A.Zr,A.te,A.bq,A.XO,A.il,A.db,A.N6,A.Gf,A.HQ,A.VR,A.EK,A.Jc,A.ET,A.lY,A.W3,A.ih,A.GV,A.OH,A.Pf,A.Fe,A.vs,A.OM,A.xI,A.m0,A.bn,A.lm,A.ar,A.KP,A.Pn,A.a1,A.vX,A.YI,A.Uk,A.zF,A.fU,A.ZF,A.a6,A.ck,A.k5,A.VS,A.CD,A.aE,A.N3,A.c8,A.Zd,A.P1,A.v,A.aA,A.wL,A.W9,A.ms,A.Mg,A.Lm,A.uu,A.DC,A.qq,A.M3,A.bM,A.VV,A.hT,A.Zz,A.px,A.u3,A.FM,A.CC,A.J,A.e,A.XG,A.Fk,A.xC])
...
r(A.Tr,A.w4)
q(A.n,[A.E1,A.Ay,A.lc,A.dC,A.VX,A.th,A.ha,A.WM,A.jZ,A.OR,A.vK,A.pU,A.F0,A.wZ,A.BW,A.HJ,A.kk,A.pH,A.dl,A.MG,A.T4,A.TK,A.ng,A.Fs,A.XU,A.xf,A.D6,A.ti,A.T9,A.Z9,A.uB,A.kW,A.pI,A.c6,A.PH,A.Cw,A.PD,A.LZ,A.E9,A.u9,A.Rz,A.DZ,A.Ak,A.lt,A.CU,A.eQ,A.wP,A.PO,A.zG,A.Bf,A.FL,A.zn,A.zC,A.U3,A.CI,A.BJ,A.Eu,A.Sem,A.u4w,A.Jba,A.Fh,A.AK,A.AX,A.dh,A.ab,A.aj,A.Sh,A.OS,A.RC,A.vW,A.np,A.ic,A.Xv,A.vN])
q(A.E1,[A.hN,A.wN,A.SX,A.Gs,A.FZ,A.mN,A.GR,A.RJ,A.eE,A.EW])
r(A.LP,A.WU)
q(A.Vj,[A.hh,A.KD])
r(A.XX,A.hh)
q(A.Ay,[A.aH,A.Vs,A.Ft,A.yH,A.Z5,A.da,A.oQ,A.fG,A.rt,A.xR,A.RT,A.rq,A.RW,A.Vp,A.Ev,A.Vb,A.Hd,A.TZ,A.lN,A.R3,A.Ug,A.Ci,A.Ka,A.Se,A.Pw,A.Vq,A.u4,A.Pl,A.ma,A.Jb,A.KaU,A.PwK,A.BJg,A.Vqd,A.Pla,A.Eub,A.maa,A.kj,A.KJ])
r(A.W0,A.m)
q(A.lc,[A.zx,A.rT])
q(A.il,[A.N5,A.uw])
q(A.eH,[A.T1,A.b0])
