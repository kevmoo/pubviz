...
s.title="pubviz - "+r.a
p=p.b.a
p=new A.GP(p,A.Lh(p).C("GP<2>")).Vr(0,new A.ur())
q.d!==$&&A.SQ()
q.d=p
p=A.Du(q)
q.a!==$&&A.SQ()
...
$S:2}
A.XG.prototype={
PJ(a){var s=this,r="change",q=s.a.d
q===$&&A.Q4()
if(!q){s.r.disabled=!0
s.f.title="No outdated packages found."}A.JE(s.w,"wheel",new A.Fh(),!1)
A.JE(s.x,"wheel",new A.AK(),!1)
A.JE(s.b,"click",new A.AX(s),!1)
A.JE(s.d,r,new A.dh(s),!1)
A.JE(s.e,r,new A.ab(s),!1)
A.JE(s.r,r,new A.aj(s),!1)
q=v.G
...
p.jz(r.classList.contains("collapsed")?"Controls Hidden":"Controls Shown")
break A}if("z"===s||"Z"===s){r=p.d
r.checked=!r.checked
q=p.a.b
q===$&&A.Q4()
q.SZ()
p.jz(r.checked?"Zoom Enabled":"Zoom Disabled")
break A}if("d"===s||"D"===s){r=p.e
r.checked=!r.checked
q=p.a.b
q===$&&A.Q4()
q.Ww()
...
$S:0};(function aliases(){var s=J.zh.prototype
...
r(A.Pl,A.B7)
q(A.mP,[A.C4,A.vG])
q(A.n,[A.E1,A.Ay,A.lc,A.dC,A.VX,A.th,A.ha,A.WM,A.jZ,A.OR,A.vK,A.pU,A.F0,A.wZ,A.BW,A.HJ,A.kk,A.pH,A.dl,A.MG,A.T4,A.TK,A.ng,A.Fs,A.XU,A.xf,A.uB,A.kW,A.pI,A.c6,A.PH,A.Cw,A.PD,A.vN,A.CU,A.eQ,A.wP,A.aV,A.GZ,A.Mv,A.zG,A.ME,A.dH,A.vk,A.ur,A.Fh,A.AK,A.AX,A.dh,A.ab,A.aj])
