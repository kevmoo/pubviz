...
if(s===r)return n.i
if(n.e===r)throw A.l(A.SY("Return interceptor for "+A.Ej(s(a,n))))}q=a.constructor
if(q==null)p=null
else{o=$.zm
...
Qi(a,b){if(a>4294967295)throw A.l(A.TE(a,0,4294967295,"length",null))
...
return s},
lh(a){var s,r,q,p
if(a instanceof A.k)return A.F(A.zK(a),null)
s=J.ia(a)
...
case 4:return a.$4(c,d,e,f)}throw A.l(new A.CD("Unsupported number of arguments for wrapped closure"))},
...
if(p[q]===a)return q}throw A.l(A.xY("Field name "+a+" not found.",null))},
...
if(a==null)return a2
return a
default:throw A.l(A.v("Attempted to substitute unexpected RTI kind "+a0))}},
...
zK(a){if(a instanceof A.k)return A.Lh(a)
...
return!1},
Vl(a){if(typeof a=="object"){if(a instanceof A.k)return t.m.b(a)
return!0}if(typeof a=="function")return!0
return!1},
Oz(a){var s=this
...
return
default:throw A.l(A.v("Unexpected state under `()`: "+A.Ej(o)))}},
I(a,b){var s=b.pop()
if(0===s){b.push(A.m(a.u,1,"0&"))
return}if(1===s){b.push(A.m(a.u,4,"1&"))
return}throw A.l(A.v("Unexpected extended operation "+A.Ej(s)))},
...
if(q!==8)throw A.l(A.v("Indexed base must be an interface type"))
s=b.y
if(c<=s.length)return s[c-1]
throw A.l(A.v("Bad index "+c+" for "+b["["](0)))},
...
E2(){A.i()
var s=new A.b()
A.J($.o(),"click",new A.e(s),!1)
A.J($.n(),"change",new A.L(),!1)
A.J(v.G.window,"keydown",new A.C(s,new A.h()),!1)},
i(){var s=0,r=A.FX(t.n),q=1,p=[],o=[],n,m,l,k,j,i,h,g,f,e
var $async$i=A.lz(function(a,b){if(a===1){p.push(b)
s=q}for(;;)switch(s){case 0:g=$.oa
if(g!=null){g.remove()
$.oa=null}j=new A.P1()
$.jv()
g=$.lE.$0()
...
l=A.Ru(f)
g=J.Rh(l)
h=B.Ph.F(g,0,g.length)
k="<pre>"+(h==null?g:h)+"</pre>"
v.G.document.querySelector("#graph-container").append(k)
o.push(5)
s=4
break
case 2:o=[1]
case 4:q=1
A.mp("Total time generating graph: "+new A.a6(n.gqs())["["](0))
s=o.pop()
break
...
m=v.G
m.document.querySelector("#graph-container").insertAdjacentHTML("beforeend",a)
...
throw A.l(A.u0("Result of truncating division is "+A.Ej(s)+": "+A.Ej(a)+" ~/ "+b))},
A(a,b){var s
if(a>0)s=this.U(a,b)
else{s=b>31?31:b
s=a>>s>>>0}return s},
...
else throw A.l(A.u0("`setTimeout()` not found."))}}
A.yH.prototype={
$0(){this.b.$0()},
$S:0}
A.ih.prototype={
...
return!1}o.a=p.pop()
m=1
continue}throw A.l(A.PV("sync*"))}return!1},
eH(a){var s,r,q=this
...
A.Pf.prototype={
T(a,b){var s=this.a
if((s.a&30)!==0)throw A.l(A.PV("Future already completed"))
s.i(A.ux(a,b))},
...
try{p=q
return p}catch(s){if(t._.b(A.Ru(s))){if((this.c&1)!==0)throw A.l(A.xY("The error handler of Future.then must return a value of the returned future's type","onError"))
throw A.l(A.xY("The error handler of Future.catchError must return a value of the future's type","onError"))}else throw s}}}
A.vs.prototype={
S(a,b,c){var s,r=$.X3
if(r===B.NU){if(!t.Q.b(b)&&!t.v.b(b))throw A.l(A.L3(b,"onError",u.c))}else b=A.VH(b,r)
...
r(A.k,null)
q(A.k,[A.FK,J.vB,A.rY,J.m1,A.Ge,A.a7,A.cX,A.MH,A.SO,A.SU,A.z,A.Tp,A.Zr,A.te,A.bq,A.XO,A.Jc,A.G,A.lY,A.W3,A.ih,A.GV,A.OH,A.Pf,A.Fe,A.vs,A.OM,A.xI,A.m0,A.ar,A.zF,A.fU,A.ZF,A.a6,A.k5,A.VS,A.CD,A.c8,A.Zd,A.P1,A.Rn,A.aA,A.Fk,A.xC])
...
q(A.cX,[A.i1,A.oi,A.q4,A.V6])
r(A.xy,A.i1)
q(A.z,[A.B7,A.w4])
r(A.Pl,A.B7)
r(A.SN,A.w4)
q(A.Tp,[A.Ay,A.eR,A.lc,A.dC,A.VX,A.th,A.ha,A.WM,A.jZ,A.OR,A.vK,A.pU,A.vN,A.e,A.L,A.C,A.AR,A.lg,A.qK,A.jf,A.qB,A.Gv,A.ID])
q(A.Ay,[A.aH,A.Vs,A.Ft,A.yH,A.da,A.oQ,A.fG,A.rt,A.xR,A.RT,A.rq,A.vQ,A.Vp,A.Ev,A.b,A.h])
r(A.ZQ,A.Ez)
q(A.lc,[A.zx,A.rT])
q(A.eR,[A.wN,A.SX,A.Gs,A.FZ])
q(A.ET,[A.df,A.b0])
q(A.b0,[A.VR,A.WB])
r(A.vX,A.VR)
r(A.Dg,A.vX)
...
s(A.WB,A.ar)
s(A.ZG,A.SU)})()
var v={G:typeof self!="undefined"?self:globalThis,typeUniverse:{eC:new Map(),tR:{},eT:{},tPV:{},sEA:[]},mangledGlobalNames:{KN:"int",CP:"double",lf:"num",qU:"String",a2:"bool",c8:"Null",zM:"List",k:"Object",Z0:"Map",vm:"JSObject"},mangledNames:{},types:["~()","~(vm)","~(@)","~(~())","KN()","c8(@)","c8()","@(@)","@(@,qU)","@(qU)","c8(~())","c8(@,Gz)","~(KN,@)","c8(k,Gz)","a2(qU)","+element,id(vm,qU)(vm)","+element,from,to(vm,qU,qU)(vm)"],interceptorsByTag:null,leafTags:null,arrayRti:Symbol("$ti"),rttc:{"2;element,id":(a,b)=>c=>c instanceof A.Pl&&a.b(c.a)&&b.b(c.b),"3;element,from,to":(a,b,c)=>d=>d instanceof A.SN&&a.b(d.a)&&b.b(d.b)&&c.b(d.c)}}
A.xb(v.typeUniverse,JSON.parse('{"iC":"zh","kd":"zh","c5":"zh","Fu":"WZ","yE":{"y5":[]},"PE":{"y5":[]},"MF":{"vm":[]},"zh":{"vm":[]},"jd":{"zM":["1"],"bQ":["1"],"vm":[]},"BC":{"rY":[]},"Po":{"jd":["1"],"zM":["1"],"bQ":["1"],"vm":[]},"qI":{"CP":[]},"im":{"CP":[],"KN":[],"y5":[]},"kD":{"CP":[],"y5":[]},"Dr":{"qU":[],"y5":[]},"a":{"Ge":[]},"i1":{"cX":["2"],"cX.E":"2"},"xy":{"i1":["1","2"],"bQ":["2"],"cX":["2"],"cX.E":"2"},"oi":{"cX":["1"],"cX.E":"1"},"ZQ":{"Ez":[],"Ge":[]},"az":{"Ge":[]},"vV":{"Ge":[]},"XO":{"Gz":[]},"Eq":{"Ge":[]},"WZ":{"vm":[],"y5":[]},"ET":{"vm":[]},"df":{"vm":[],"y5":[]},"b0":{"Xj":["1"],"vm":[]},"Dg":{"ar":["CP"],"zM":["CP"],"Xj":["CP"],"bQ":["CP"],"vm":[]},"DV":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[]},"zU":{"ar":["CP"],"zM":["CP"],"Xj":["CP"],"bQ":["CP"],"vm":[],"y5":[],"ar.E":"CP"},"K8":{"ar":["CP"],"zM":["CP"],"Xj":["CP"],"bQ":["CP"],"vm":[],"y5":[],"ar.E":"CP"},"xj":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"dE":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"Zc":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"wf":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"Pq":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"eE":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"or":{"ar":["KN"],"zM":["KN"],"Xj":["KN"],"bQ":["KN"],"vm":[],"y5":[],"ar.E":"KN"},"u9":{"Ge":[]},"iM":{"Ez":[],"Ge":[]},"q4":{"cX":["1"],"cX.E":"1"},"OH":{"Ge":[]},"Zf":{"Pf":["1"]},"vs":{"b8":["1"]},"V6":{"cX":["qU"],"cX.E":"qU"},"zM":{"bQ":["1"]},"C6":{"Ge":[]},"Ez":{"Ge":[]},"AT":{"Ge":[]},"bJ":{"Ge":[]},"ub":{"Ge":[]},"ds":{"Ge":[]},"lj":{"Ge":[]},"UV":{"Ge":[]},"k5":{"Ge":[]},"VS":{"Ge":[]},"Zd":{"Gz":[]},"ZX":{"zM":["KN"],"bQ":["KN"]},"n6":{"zM":["KN"],"bQ":["KN"]},"zt":{"zM":["KN"],"bQ":["KN"]},"rF":{"zM":["KN"],"bQ":["KN"]},"yc":{"zM":["KN"],"bQ":["KN"]},"X6":{"zM":["KN"],"bQ":["KN"]},"Pz":{"zM":["KN"],"bQ":["KN"]},"oI":{"zM":["CP"],"bQ":["CP"]},"mJ":{"zM":["CP"],"bQ":["CP"]}}'))
A.FF(v.typeUniverse,JSON.parse('{"SO":1,"SU":1,"b0":1,"GV":1,"xI":1,"zF":2,"xC":1}'))
var u={c:"Error handler must accept one Object or one Object and a StackTrace as arguments, and return a value of the returned future's type"}
var t=(function rtii(){var s=A.q7
return{O:s("bQ<@>"),C:s("Ge"),Z:s("EH"),f:s("jd<k>"),s:s("jd<qU>"),b:s("jd<@>"),q:s("jd<qU?>"),T:s("PE"),m:s("vm"),g:s("c5"),p:s("Xj<@>"),j:s("zM<@>"),P:s("c8"),K:s("k"),L:s("VY"),F:s("+()"),a:s("+element,id(vm,qU)"),h:s("+element,from,to(vm,qU,qU)"),l:s("Gz"),N:s("qU"),R:s("y5"),_:s("Ez"),o:s("kd"),c:s("vs<@>"),d:s("q4<vm>"),y:s("a2"),i:s("CP"),z:s("@"),v:s("@(k)"),Q:s("@(k,Gz)"),S:s("KN"),U:s("b8<c8>?"),A:s("vm?"),X:s("k?"),w:s("qU?"),u:s("a2?"),I:s("CP?"),t:s("KN?"),x:s("lf?"),H:s("lf"),n:s("~")}})();(function constants(){B.Ok=J.vB.prototype
B.Nm=J.jd.prototype
B.jn=J.im.prototype
B.CD=J.qI.prototype
B.xB=J.Dr.prototype
...
$.X3=B.NU
$.jE=null
$.oa=null})();(function lazyInitializers(){var s=hunkHelpers.lazyFinal
