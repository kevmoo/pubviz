...
b===$&&A.Q4()
a=n.gxR()
a0=a.WH(0,"devDependenciesCheckbox").checked
a1=a.WH(0,"outdatedOnlyCheckbox").checked
a2=a.WH(0,"workspaceOnlyCheckbox").checked
m=A.iQ(b.c6(a0,a.WH(0,"hideIsolatedCheckbox").checked,a1,a2))
s=a7?12:14
break
case 12:s=15
return A.j(A.f(v.G.window.navigator.clipboard.writeText(m),t.X),$async$dV)
...
break
case 10:b=v.G
l=b.document.querySelector("#graph-container svg")
...
break
case 16:s=19
return A.j(A.f(b.window.navigator.clipboard.writeText(j),t.X),$async$dV)
case 19:n.jz("SVG Copied to Clipboard")
s=17
break
case 18:n.DD(j,"dependencies.svg","image/svg+xml")
case 17:s=8
break
case 11:b=v.G
i=b.document.querySelector("#graph-container svg")
if(i==null){n.jz("\u26a0\ufe0f No graph found to export")
s=1
break}n.jz("Processing PNG...")
h=i.outerHTML
g=A.Bt(h)
f=new b.Blob(A.QI([g],t.s),{type:"image/svg+xml"})
e=b.URL.createObjectURL(f)
a3=b.document.createElement("img")
a3.src=e
d=a3
d.onload=A.k6(new A.OS(n,i,d,e,a7))
d.onerror=A.k6(new A.np(n,e))
s=8
break
case 8:p=2
s=6
...
$S:11}
A.kj.prototype={
$0(){var s=0,r=A.F(t.P),q=1,p=[],o=this,n,m,l,k,j,i,h,g
var $async$$0=A.l(function(a,b){if(a===1){p.push(b)
s=q}for(;;)switch(s){case 0:q=3
j=v.G
n=j.window.navigator.clipboard
i={}
i["image/png"]=o.b
m=i
l=new j.ClipboardItem(m)
j=o.a
s="write" in n?6:8
break
case 6:s=9
return A.j(A.f(n.write(A.QI([l],t.O)),t.X),$async$$0)
case 9:j.jz("PNG Copied to Clipboard")
s=7
break
case 8:j.jz("\u26a0\ufe0f Browser does not support clipboard write")
case 7:q=1
s=5
break
case 3:q=2
g=p.pop()
k=A.Ru(g)
o.a.jz("\u26a0\ufe0f Browser blocked image clipboard write: "+A.Ej(k))
s=5
break
case 2:s=1
break
