...
DE(a4){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3=new A.v("")
a3.a="flowchart TD\n"
...
p=A.QI([],r)
o=A.QI([],r)
for(r=a4.b.a,n=r.gUQ(),n=n.gkz(n),m=new A.SO(n,new A.N0(B.xD)),l=a4.c;m.G();){k=n.gl()
j=a4.gY()
i=k.a
h=j.a===i
g=l&&h?"\u2699\ufe0f "+i:i
...
c=k?")":"]"
s+="  "+i+d+'"'+g+'"'+c+"\n"
a3.a=s}for(s=r.gUQ(),s=s.gkz(s),r=new A.SO(s,new A.Bh(B.xD));r.G();){n=s.gl()
m=a4.gY()
l=n.a
k=n.c.a
k=A.ev(k,A.Lh(k).c)
...
b=k
B.Nm.Jd(b)
for(k=B.Nm.gkz(b),j=new A.SO(k,new A.ky(B.xD)),m=m.a!==l,n=n.d,l="  "+l+" ";j.G();){f=k.gl()
e=f.c
if(!e||!m||n){a=f.b
a0=!a.gBv()
a1=a0?' "'+a["["](0)+'"':""
...
f=l+a2+" "+f.a+"\n"
a3.a+=f}}}if(q.length!==0){s="  class "+B.Nm.zV(q,",")+" primary;\n"
a3.a+=s}if(p.length!==0){s="  class "+B.Nm.zV(p,",")+" outdated;\n"
a3.a+=s}if(o.length!==0){s="  class "+B.Nm.zV(o,",")+" publishToNone;\n"
a3.a+=s}s=a3.a
