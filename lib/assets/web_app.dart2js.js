...
A.e.prototype={}
A.XG.prototype={
PJ(a){var s,r=this,q=r.a.c
q===$&&A.Q4()
if(!q.gH4()){r.f.disabled=!0
r.e.title="No outdated packages found."}q=v.G
s=q.document.body
s.toString
A.JE(s,"wheel",new A.Fh(),!1)
s=q.document.body
s.toString
A.JE(s,"change",new A.AK(r),!1)
s=q.document.body
s.toString
A.JE(s,"click",new A.AX(r),!1)
A.JE(q.window,"keydown",r.gMh(),!1)
q=q.document.querySelector("#version")
if(q==null)q=A.AN(q)
q.textContent="v6.1.0-wip"},
...
r===$&&A.Q4()
r.Fc()
break A}if("devDependenciesCheckbox"===s||"outdatedOnlyCheckbox"===s||"workspaceOnlyCheckbox"===s){r=this.a.a.b
r===$&&A.Q4()
r.W()}}},
$S:1}
A.AX.prototype={
